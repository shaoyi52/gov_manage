    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="data" border class="table" ref="multipleTable" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="workingSeniority" label="从业时间" width="120">
                </el-table-column>
                <el-table-column prop="touristsCount" label="游客数"  width="120">                                      
                </el-table-column>              
                <el-table-column prop="groupBonus" label="达标团次" width="150">
                </el-table-column>                 
                 <el-table-column prop="hasBonus" label="应奖励金额（元）" width="120">
                </el-table-column>             
                 <el-table-column prop="isBonus" label="是否已奖励" width="120" :formatter="formatter">
                </el-table-column>             
